...
import com.picha.proverbs.SplashActivity;

import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class BaseActivity extends AppCompatActivity {

    public static String BASE_URL = "http://172.20.10.3/thaiproverbs/api.php?";
    public static String BASE_URL_PICTURE = "http://172.20.10.3/thaiproverbs/image/";
